...
import ModifyBoardPage from "./pages/boardPages/ModifyBoardPage/ModifyBoardPage";
  ...
  return (
    <>
      <Routes>
        ...
        {/* boardId가 바꿔서 들어갈 때마다 재렌더링*/}
        <Route path="/board/write" element={<WritePage />} />
        <Route path="/board/write/:boardId" element={<ModifyBoardPage />} />
